...
def cam():
    message_box2 = messagebox.showinfo(title="Bilgilendirme!", message="Kapatmak için 'Tamam' tuşuna basınız!")
    km.kamera()


def search():
    message_box = messagebox.showerror(title="Uyarı!", message="Şu an için bu özellik çalışmıyor!")

def alg():
    message_box4 = messagebox.showinfo(title="Bilgilendirme!", message="Geçmek için 'Tamam' tuşuna basınız!")
    import alg1
...
button1 = tk.Button(frame2,text="İlerlet",activebackground="red",
